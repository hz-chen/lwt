...
__thread struct lwt_kthd_evnt (*kthd_ring_buf)[_LWT_KTHD_EVNT_BUF] = NULL;
__thread int kthd_rbuf_cons = 0, 
		 kthd_rbuf_prod = 0, 
		 kthd_rbuf_len = 0;
__thread pthread_t kthd_self = 0;
__thread kthd_t kthd_index = 0;

__thread _lwt_tcb lwt_lst_root[_LWT_SIZE];
__thread int lwt_lst_tail = 0;
...
__thread lwt_t lwt_rdyq_head = NULL;
__thread lwt_t lwt_rdyq_tail = NULL;
__thread lwt_t lwt_dead_head = NULL;
__thread lwt_t lwt_dead_tail = NULL;
