...
extern __thread struct lwt_kthd_evnt (*kthd_ring_buf)[_LWT_KTHD_EVNT_BUF];
extern __thread struct lwt_kthd_evnt nil_evnt;
extern __thread int kthd_rbuf_cons, kthd_rbuf_prod, kthd_rbuf_len;
extern __thread pthread_t kthd_self;
extern __thread kthd_t kthd_index;
...
extern __thread _lwt_tcb lwt_lst_root[_LWT_SIZE];
//This is the pointer to the tail node.
extern __thread int lwt_lst_tail;
...
extern __thread lwt_t lwt_rdyq_head;
extern __thread lwt_t lwt_rdyq_tail;
//we have a dead queue, for reuse:
extern __thread lwt_t lwt_dead_head;
extern __thread lwt_t lwt_dead_tail;
//memory barriers;
//extern __thread int barrier;
...
extern __thread int num_of_threads;
extern __thread int length_of_rdyq;
extern __thread int length_of_deadq;

extern __thread _lwt_tcb* curr_tcb;
